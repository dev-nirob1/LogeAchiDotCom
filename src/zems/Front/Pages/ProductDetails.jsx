            ...
            <div className="mt-6 space-y-4">
              <div className="accordion border rounded-sm border-gray-300">
                ...
                <p className="p-4">
                  ...
                  is the perfect choice for effortless summer style. Crafted for
                  comfort and breathability, this lightweight shirt keeps you
                  warn during cool days. With its relaxed fit and timeless
