import { FaHeadset, FaShippingFast, FaTags, FaUndo } from "react-icons/fa";
    ...
    <section>
      <div className="my-container">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="why-choose-card rounded shadow-sm p-4 grid grid-cols-4 items-center">
            <FaShippingFast className="text-5xl text-dark" />
